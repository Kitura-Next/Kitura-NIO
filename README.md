...
<a href="https://kitura-next.github.io/Kitura-NIO/index.html">
<img src="https://img.shields.io/badge/apidoc-KituraNIO-1FBCE4.svg?style=flat" alt="APIDoc">
</a>
<a href="https://travis-ci.org/Kitura-Next/Kitura-NIO">
<img src="https://travis-ci.org/Kitura-Next/Kitura-NIO.svg?branch=master" alt="Build Status - Master">
</a>
...
Visit [www.kituranext.org](http://www.kituranext.org/) for reference documentation.
...
`$ git clone https://github.com/Kitura-Next/Kitura-NIO && cd Kitura-NIO`
...
In some Linux environments, a low open file limit could cause test failures. See [this](https://github.com/Kitura-Next/Kitura-NIO/issues/1).
...
This library is licensed under Apache 2.0. The full license text is available in [LICENSE](https://github.com/Kitura-Next/Kitura-NIO/blob/master/LICENSE.txt).
